     	  ...
     	  <tr class="wpf-htr">
            ...
            <?php foreach($posts as $post) : extract($post, EXTR_OVERWRITE); ?>
	          ...
	          <tr class="wpf-ttr">
	            ...
	            <td class="wpf-spost-title"><a href="<?php echo esc_url(WPF()->post->get_post_url($postid)) ?>" title="<?php wpforo_phrase('View entire post') ?>"><?php echo esc_html($title) ?> &nbsp;<i class="fa fa-chevron-right" style="font-weight:100; font-size:11px;"></i></a></td>
