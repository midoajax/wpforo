              ...
              <?php if( wpforo_feature('user-register-email-confirm') ): ?>
                  <div class="wpf-tr">
                        <div class="wpf-td wpfw-1">
                        	<div class="wpf-field"><i class="fa fa-info-circle wpfcl-5" aria-hidden="true" style="font-size:16px;"></i> &nbsp;<?php wpforo_phrase('After registration you will receive an email confirmation with a link to set a new password') ?></div>
