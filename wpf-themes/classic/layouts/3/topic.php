      ...
      <div class="topic-wrap <?php echo $class ?>">
          <div class="wpforo-topic">
              ...
              <div class="wpforo-topic-info">
                <p class="wpforo-topic-title <?php wpforo_unread_topic($topic['topicid']) ?>"><a href="<?php echo esc_url($topic_url) ?>"><i class="fa fa-1x <?php echo $classes ?>" title="<?php $icon_title = WPF()->tpl->icon('topic', $topic, false, 'title'); if( $icon_title ) echo esc_html($icon_title) ?>"></i> <?php wpforo_text($topic['title'], 70); ?></a></p>
